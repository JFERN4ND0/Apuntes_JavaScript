...
? Hijos - child (Nodo que desciende de un padre)
    ...
    ⁡⁣⁢⁣firstElementChild⁡ -> Devuelve el primer nodo elemento
    hijo
    ⁡⁣⁢⁣lastChild⁡ -> Devuelve el último nodo hijo
    ⁡⁣⁢⁣lastElementChild⁡ -> Devuelve el último nodo elemento
    hijo
    ⁡⁣⁢⁣hasChildNodes()⁡ -> Devuelve true si el nodo tiene
    hijos y false si no tiene
...
? Cercano
    ⁡⁣⁢⁣closest(selector)⁡ -> Selecciona el nodo más cercano que
    cumpla con el selector, aún es experimental.
*/
